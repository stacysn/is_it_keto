...
<ul>
	...
	<li> Run 'npm run start' to run the project on http://localhost:3000</li><br>	
...
<li>Makes sure your pull request describes exactly what you changed and if it relates to an open issue, reference that issue (just include the issue number in the title like this: #49)</li><br>
</ul>	
