      ...
      <div>
        ...
        <div id="results">
          {this.props.results.map( (element, index) => {
            const foodName = (food) => { return food.charAt(0).toUpperCase() + food.slice(1); };
            ...
            return(
              <div key={index}>
                <b>{foodName(this.props.results[index].food_name)} &mdash; {netCarbs < 10 ? 'Keto-friendly!': 'not Keto-friendly.'}</b>
