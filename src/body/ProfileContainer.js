		...
		return (
			<div className="profile-container">
				...
				<div className="graphContainer">
					<Line data={this.state.data} options={this.state.options} redraw={true} width="600" height="250" />
				</div>
				<ProfileFoodResults foodEntries={this.state.resultCardData} handleRefresh={this.handleRefresh} />
